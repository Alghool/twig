...
namespace Alghool\Twig\Commands;
...
class TwigPublish extends BaseCommand
{
    ...
    /**
     * The path to Alghool\Twig\src directory.
     *
     * @var string
     */
    ...
    protected function publishConfig()
    {
        ...
        $content = str_replace('namespace Alghool\Twig\Config', 'namespace Config', $content);
        $content = str_replace('extends BaseConfig', 'extends \\Alghool\\Twig\\Config\\Twig', $content);
